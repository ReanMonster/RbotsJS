...
class LINE extends Command {
    ...
    get myBot() {
        const bot = ['u50a276d6b4571941fa524c6cae200cd7','ubd652fb9cc05aaaf6983b4d12297bee6'];
        return bot; 
    }
    ...
    async textMessage(messages) {
        ...
        this.command('Halo', ['halo to','can i help you?']);
        this.command('.help', `==== Rbots JS ====\n\n.status\n.left\n.speed\n.myid\n.kernel\n.ip\n.ig\n.qr\n.joinqr\n.spam\n.creator\n.pap\n.upload\n.vn\nkick on/off\ncancel on/off\n.qrp on/off\n.cancelall\nkickall\n.set\n.recheck\n.clearall\n\n==== Monster Bots ====`);
        this.command('.how you', this.getProfile.bind(this));
        ...
        this.command(`? ${payload}`,this.kickAll.bind(this));
        this.command(`? ${payload}`, this.cancelMember.bind(this));
